...
--
-- Host: localhost    Database: barbershop_hair_color_service
-- ------------------------------------------------------
...
CREATE TABLE `hair_color` (
  ...
  `price` int NOT NULL,
  `color_code` varchar(20) COLLATE utf8mb4_vietnamese_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
-- Dump completed on 2024-12-13  9:55:54
