    ...
    >
          ...
          <div className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white">
            <input
              onClick={() => {
                ...
                (document.querySelector(`#line-chart-${idToggle}`) as any).click();
              }}
      ...
      <div className="p-2 flex justify-center items-center">
        <button
          ...
          type="button" className="inline-flex items-center py-2.5 px-4 text-xs font-medium text-center text-white bg-primary-700 rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800"
        >
          View
        </button>
      </div>
